...
from src.imagenet.models import Model
...
from src.imagenet.image_ops import batch_norm_with_mask
from src.imagenet.image_ops import relu
from src.imagenet.image_ops import max_pool
from src.imagenet.image_ops import drop_path
...
class MicroChild(Model):
  def __init__(self,
    ...
    self.pool_layers = [pool_distance, 2 * pool_distance, 3 * pool_distance+1]
